 ...
 * Deploy
 *
 * @package Pronamic\WordPress\Orbis\InfiniteWP
 */
...
set( 'plugin_slug', 'orbis-infinitewp' );
...
host( 'orbis.pronamic.nl' )
	...
	->set( 'port', 18765 )
	->set( 'deploy_path', '~/projects/wp-orbis-infinitewp' )
...
task(
	'deploy:update_code',
	function () {
		upload( '{{build_path}}/orbis-infinitewp/', '{{release_path}}' );
	}
);
